return { -- abstract action
    ...
    canUse = function(self)
        local condition = self.entity:getComponentByName("StateMachine").currentState.name == 'small_vamp_combo_first' 
    ...
    onActive = function(self)
        ...
        if stateMachine.currentState then
            ...
            stateMachine:goToState("small_vamp_combo_second", {input = self.input})
        end
    end
}